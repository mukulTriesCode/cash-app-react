...
const NotificationModal: React.FC<{
  ...
  return (
    <div
      data-lenis-prevent
      className="fixed w-screen h-screen z-[1001] bg-black/50 left-0 top-0 overflow-y-scroll p-52"
      onClick={(e) => {
    ...
    >
      <div className="max-w-[800px] flex flex-col gap-4 mx-auto w-full p-8 bg-[#131313] rounded-xl">
